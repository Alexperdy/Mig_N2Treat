...
%SavePath = 'D:\\Universidade\\5º Ano 1º Semestre\\Thesis\\MATLAB\\MS_DATA\\kmeans_2_20_10000_50\\';
%SavePath = 'C:\\Users\\alexp\\OneDrive\\Ambiente de Trabalho\\Thesis\\MATLAB\\DATA\\MS_DATA\\AAHC\\';
SavePath = 'D:\\Universidade\\5º Ano 1º Semestre\\Thesis\\MATLAB\\DATA\\MS_DATA\\AAHC\\';
%SavePath = 'D:\\Universidade\\5º Ano 1º Semestre\\Thesis\\MATLAB\\DATA\\test_PA_filter\\teste\\sub-%s%03d\\sub-%s%03d_ses-%s_task-mentalizing_eeg_pre_06-Rest1.mat';
%SavePath = 'C:\Users\alexp\OneDrive\Ambiente de Trabalho\Thesis\MATLAB\MS_DATA\kmeans_2_20_Inf_50\';
...
for i = controls
    tmpEEG = load(sprintf(SavePath,'control',i,'control',i,'midcycle'));
    tmpEEG = tmpEEG.EEG;
...
for i = patients
    tmpEEG = load(sprintf(SavePath,'patient',i,'patient',i,'interictal'));
    tmpEEG = tmpEEG.EEG;
    %tmpEEG = pop_loadset(strcat(sprintf(setfil,type,i,ses,task),'_outliers.set'),sprintf(setpath,type,i));
    [ALLEEG, tmpEEG, CURRENTSET] = pop_newset(ALLEEG, tmpEEG, 0,'gui','off'); % And make this a new set
    tmpEEG = pop_clean_rawdata(tmpEEG, 'FlatlineCriterion','off','ChannelCriterion','off','LineNoiseCriterion','off','Highpass','off','BurstCriterion',5,'WindowCriterion',0.25,'BurstRejection','on','Distance','Euclidian','WindowCriterionTolerances',[-Inf 7] );
...
%FitPars = struct('nClasses',4,'lambda',10,'b',30,'PeakFit',1, 'BControl',1,'Rectify',0,'Normalize',0);
