...
% We can want to fit the PR and PI data using maps obtained by using all
% the data (what we did above!)
...
% Below is the code to fit the data using the group MS, or the grand mean
% maps, or the literature maps
